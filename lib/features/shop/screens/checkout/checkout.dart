...
import 'package:jurix_app/common/widgets/success_screen/success_screen.dart';
...
import 'package:jurix_app/navigation_menu.dart';
...
class CheckoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: TAppBar(
        showBackArrow: true,
        title: Text('Order Review', style: Theme.of(context).textTheme
        .headlineSmall),
    ),
    ...
    onPressed: () => Get.to(() => SuccessScreen(image: TImages.successfulPaymentIcon, title: 'Payment Success!', subTitle: 'Your item will be shipped soon!', onPressed: () => Get.offAll(() => const NavigationManu(),),
    ),),
